...
export const portfolio = {
  ...
  projects: [
    ...
    },
    {
      ...
      description: "A corporate financial monitoring dashboard that visualizes key business metrics, revenue, expenses, and performance trends through interactive charts and data tables. Built with React, Vite, and TypeScript to deliver clear insights and data visualization for decision-making.",
